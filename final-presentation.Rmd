...
p_id=read.csv("全国累计确诊人数(6.17_24时).csv")
...
```{r echo=FALSE, results='asis',warning = FALSE}
#library(ggplot2)
dataforei <- read.csv("comefromforeign.csv", header = T)
...
#library(ggplot2)
data31 <- read.table("World.csv",header = TRUE,sep = ",")
...
```{r echo = FALSE, results='asis', warning = FALSE}
mydata <- read.table("data_Italy2.csv",header = TRUE,sep = ",")
